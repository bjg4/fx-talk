...
Experimental, with assisted setup. Developer ID-signed, not yet notarized. One hardware combination has been physically verified; see [compatibility](docs/COMPATIBILITY.md).
